...
class Match_state_controller:
    def __init__(self, home_team_controller,away_team_controller,possesion):
        ...
        # Creamos el modelo
        self.match_state = Match_state(home_team_controller.team,away_team_controller.team,self.possession)
