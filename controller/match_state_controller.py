...
class Match_state_controller:
    def __init__(self, home_team_controller,away_team_controller,seconds_match_time,possession,quarter):
        ...
        # Creamos el modelo
        self.match_state = Match_state(home_team_controller.team,away_team_controller.team,seconds_match_time,self.possession,quarter)
